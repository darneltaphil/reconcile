...
/**
 *    ParseXLSX php class v0.8.5
 *    MS Excel 2007 workbooks reader
 *
 * Copyright (c) 2012 - 2019 ParseXLSX
 *
 * @category   ParseXLSX
 * @package    ParseXLSX
 * @copyright  Copyright (c) 2012 - 2019 ParseXLSX (https://github.com/shuchkin/ParseXLSX/)
 * @license    MIT
 * @version    0.8.5
 */
 ...
 *
 * Example 1:
 * if ( $xlsx = ParseXLSX::parse('book.xlsx') ) {
 *   print_r( $xlsx->rows() );
 * } else {
 *   echo ParseXLSX::parseError();
 * }
 *
 ...
 *
 * Example 3: rowsEx
 * $xlsx = ParseXLSX::parse('book.xlsx');
 * print_r( $xlsx->rowsEx() );
 *
 ...
 *
 * Example 8: read data
 * if ( $xslx = ParseXLSX::parse( file_get_contents('http://www.example.com/example.xlsx'), true) ) {
